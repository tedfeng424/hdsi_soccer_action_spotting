...
def main(args):
    ...
    #checkpoint = torch.load(os.path.join("SoccerNetv2-DevKit/Task1-ActionSpotting/TemporallyAwarePooling/models", args.model_name, "model.pth.tar"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_epochs',   required=False, type=int,   default=190,     help='Maximum number of epochs' )
