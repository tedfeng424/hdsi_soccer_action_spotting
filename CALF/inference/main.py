...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_features', required=False, type=int,   default=1024,     help='Number of input features' )
    parser.add_argument('--chunks_per_epoch', required=False, type=int,   default=18000,     help='Number o  f chunks per epoch' )
