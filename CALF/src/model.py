...
class ContextAwareModel(nn.Module):
    def __init__(self, weights=None, input_size=1024, num_classes=3, chunk_size=240, dim_capsule=16, receptive_field=80, num_detections=5, framerate=2):
        """
        ...
        # Process input
        # self.linear_input1 = nn.Linear(1024, 768)
        # self.linear_input2 = nn.Linear(768, input_size)
    ...
    def forward(self, inputs):
        ...
        # Process Inputs
        # inputs1 = self.linear_input1(inputs)
        # inputs2 = self.linear_input2(inputs1)
...
# Input size:  torch.Size([32, 1, 240, 1024]) batch x 1 x chunk x image_dim
# Conv_1 size:  torch.Size([32, 128, 240, 1])
# Conv_2 size:  torch.Size([32, 32, 240, 1])
# Conv_p_1 size:  torch.Size([32, 8, 240, 1])
# Conv_p_2 size:  torch.Size([32, 16, 240, 1])
# Conv_p_3 size:  torch.Size([32, 32, 240, 1])
# Conv_p_4 size:  torch.Size([32, 64, 240, 1])
# Concatenation size:  torch.Size([32, 152, 240, 1])
# Conv_seg size:  torch.Size([32, 272, 240, 1])
# Conv_seg_permuted size:  torch.Size([32, 240, 1, 272])
# Conv_seg_reshaped size:  torch.Size([32, 240, 16, 17])
# Conv_seg_norm:  torch.Size([32, 240, 16, 17])
# Output_segmentation size:  torch.Size([32, 240, 17])
# Output_segmentation_reverse size:  torch.Size([32, 240, 17])
# Output_segmentation_reverse_reshaped size:  torch.Size([32, 240, 1, 17])
# Output_segmentation_reverse_reshaped_permutted size:  torch.Size([32, 17, 240, 1])
# Concatenation_2 size:  torch.Size([32, 289, 240, 1])
# Conv_spot size:  torch.Size([32, 289, 119, 1])
# Conv_spot_1 size:  torch.Size([32, 32, 119, 1])
# Conv_spot_1_pooled size:  torch.Size([32, 32, 59, 1])
# Conv_spot_2 size:  torch.Size([32, 16, 59, 1])
# Conv_spot_2_pooled size:  torch.Size([32, 16, 29, 1])
# Spotting_reshape size:  torch.Size([32, 464, 1, 1])
# Conf_pred size:  torch.Size([32, 15, 2])
# Conf_class size:  torch.Size([32, 15, 17])
# Output_spotting size:  torch.Size([32, 15, 19])